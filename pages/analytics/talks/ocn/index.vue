<template>
    <div class="mt-14 mb-40">
        ...
        <h2 class="uppercase font-bold text-2xl mb-6 pb-6 border-b-2">
            ...
            <div
            v-for="(ocn_aw_shop, index) in ocn_aw_shops" :key="index"
            class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 shadow-lg"
            >
            <nuxt-link :to="{ name: 'analytics-talks-ocn-oawesome', params: { oawesome: ocn_aw_shop.ocn_aw_id }}">
...
export default {
    ...
    mounted() {
        var self = this;
        self.ocn_aw_shops.push(...[{"name":"二見","ocn_aw_id":"1"},{"name":"明石","ocn_aw_id":"2"}])
    }
}
</script>
<style lang="">
