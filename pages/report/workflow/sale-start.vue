<template>
    <div class="nipo_conatiner bg-white border rounded-lg py-2 mt-4 shadow-lg">
        ...
        <div class="mb-4">
            ...
            <!-- <input v-model="time" type="time" name="time" class="border rounded-lg p-2 w-11/12 ease-linear transition-all duration-150"> -->
            <Datetime
                v-model="requestDate"
                :minute-interval="30"
                :format="'HH:mm'"
...
export default {
    ...
    methods: {
        PushNipo: function() {
            ...
            var usersSkpCol = firestore().collection(`users/${CurrentUser.uid}/sale_start`)
            usersSkpCol.add({
