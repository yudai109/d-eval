<template>
  <div>
    <VueJsonToCsv :json-data=json_data :labels=labels>
      ...
      <button @click.once="getSkpData" class="rounded-lg bg-blue-400 py-2 px-3 my-5 ">
    ...
    <div class="w-11/12 mx-auto">
        ...
        >
          <div slot="table-actions" ><button class="mx-6 px-4 py-2 rounded-lg bg-yellow-500 ">関西</button></div>
          ...
          <!-- CSVダウンロードボタン -->
            <div slot="selected-row-actions">
              <button class="csv-btn rounded-lg bg-blue-400 py-2 px-3 text-white">CSVダウンロード</button>
            </div>
        </vue-good-table>
